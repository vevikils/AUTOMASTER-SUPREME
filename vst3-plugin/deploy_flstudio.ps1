# Deployment script for AUTOMASTER SUPREME 3.4 VST3
$ErrorActionPreference = "Stop"

$source = "c:\Users\alfaswz\.gemini\antigravity-ide\scratch\agentes-personalizados\vst3-plugin\build\AutomasterSupreme_artefacts\Release\VST3\AUTOMASTER SUPREME 3.4.vst3"
$targetDir = "C:\Program Files\Common Files\VST3"
$target = Join-Path $targetDir "AUTOMASTER SUPREME 3.4.vst3"
$oldTarget = Join-Path $targetDir "AUTOMASTER SUPREME 3.4.vst3.old"
...
if (Test-Path $target) {
    Write-Host "SUCCESS: AUTOMASTER SUPREME 3.4 VST3 installed to $target"
