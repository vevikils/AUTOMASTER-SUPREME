# Guía de Instalación y Uso en FL Studio: AUTOMASTER SUPREME 3.1 VST3 (v3.1) · Por vevi

Esta guía detalla cómo utilizar **AUTOMASTER SUPREME 3.1** (creado por **vevi**) como plugin VST3 nativo en **FL Studio**, cómo usar la **Leyenda Interactiva** de controles y cómo aprovechar la calibración para los estándares oficiales de **Spotify (-14 LUFS / -1.0 dBTP)**.
...
3. **La Solución de AUTOMASTER SUPREME 3.1 con Leyenda Interactiva**:
   ...
   - Botón **`📖 LEYENDA DE CONTROLES`** para consultar la tabla resumen de todos los módulos en cualquier instante.
...
1. **Ubicación Estándar de VST3 en Windows**:
   ...
   (El plugin `AUTOMASTER SUPREME 3.1.vst3` ya ha sido instalado en esa ubicación).
...
2. **Escanear el Plugin en FL Studio**:
   ...
   - Cuando termine el escaneo, busca **AUTOMASTER SUPREME 3.1** en la lista de efectos (*Effects*).
...
3. **Insertar en el Canal Master**:
   ...
   - En cualquiera de los 10 slots de inserción (Slot 1 a 10), haz clic y selecciona **AUTOMASTER SUPREME 3.1**.
