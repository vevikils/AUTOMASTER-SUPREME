# Guía de Instalación y Uso en FL Studio: AUTOMASTER SUPREME 3.2 VST3 (v3.2) · Por vevi

Esta guía detalla cómo utilizar **AUTOMASTER SUPREME 3.2** (creado por **vevi**) como plugin VST3 nativo en **FL Studio**, cómo alternar entre **Modo Oscuro y Claro (Dark/Light)**, cómo usar la **Leyenda Interactiva** de controles y cómo aprovechar la calibración para los estándares oficiales de **Spotify (-14 LUFS / -1.0 dBTP)**.
...
3. **La Solución de AUTOMASTER SUPREME 3.2 con Modo Dual y Motor Optimizado**:
...
1. **Ubicación Estándar de VST3 en Windows**:
   ...
   (El plugin `AUTOMASTER SUPREME 3.2.vst3` ya ha sido instalado en esa ubicación).
...
2. **Escanear el Plugin en FL Studio**:
   ...
   - Cuando termine el escaneo, busca **AUTOMASTER SUPREME 3.2** en la lista de efectos (*Effects*).
...
3. **Insertar en el Canal Master**:
   ...
   - En cualquiera de los 10 slots de inserción (Slot 1 a 10), haz clic y selecciona **AUTOMASTER SUPREME 3.2**.
